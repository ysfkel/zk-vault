...
contract IncrementalMerkleTree {
    ...
    function zeros(uint256 i) public pure returns (bytes32) {
        ...
        if (i == 0) {
            ...
            return bytes32(0x03d0dc8c92e2844abcc5fdefe8cb67d93034de0862943990b09c6b8e3fa27a86); // this is just a placeholder value, you should replace it with the actual computed hash for depth 8
        } else if (i == 9) {
            return bytes32(0x1d51ac275f47f10e592b8e690fd3b28a76106893ac3e60cd7b2a3a443f4e8355); // this is just a placeholder value, you should replace it with the actual computed hash for depth 9
        } else if (i == 10) {
            return bytes32(0x16b671eb844a8e4e463e820e26560357edee4ecfdbf5d7b0a28799911505088d); // this is just a placeholder value, you should replace it with the actual computed hash for depth 10
        } else if (i == 11) {
            return bytes32(0x115ea0c2f132c5914d5bb737af6eed04115a3896f0d65e12e761ca560083da15); // this is just a placeholder value, you should replace it with the actual computed hash for depth 11
        } else if (i == 12) {
            return bytes32(0x139a5b42099806c76efb52da0ec1dde06a836bf6f87ef7ab4bac7d00637e28f0); // this is just a placeholder value, you should replace it with the actual computed hash for depth 12
        } else if (i == 13) {
            return bytes32(0x0804853482335a6533eb6a4ddfc215a08026db413d247a7695e807e38debea8e); // this is just a placeholder value, you should replace it with the actual computed hash for depth 13
        } else if (i == 14) {
            return bytes32(0x2f0b264ab5f5630b591af93d93ec2dfed28eef017b251e40905cdf7983689803); // this is just a placeholder value, you should replace it with the actual computed hash for depth 14
        } else if (i == 15) {
            return bytes32(0x170fc161bf1b9610bf196c173bdae82c4adfd93888dc317f5010822a3ba9ebee); // this is just a placeholder value, you should replace it with the actual computed hash for depth 15
        } else if (i == 16) {
            return bytes32(0x0b2e7665b17622cc0243b6fa35110aa7dd0ee3cc9409650172aa786ca5971439); // this is just a placeholder value, you should replace it with the actual computed hash for depth 16
        } else if (i == 17) {
            return bytes32(0x12d5a033cbeff854c5ba0c5628ac4628104be6ab370699a1b2b4209e518b0ac5); // this is just a placeholder value, you should replace it with the actual computed hash for depth 17
        } else if (i == 18) {
            return bytes32(0x1bc59846eb7eafafc85ba9a99a89562763735322e4255b7c1788a8fe8b90bf5d); // this is just a placeholder value, you should replace it with the actual computed hash for depth 18
        } else if (i == 19) {
            return bytes32(0x1b9421fbd79f6972a348a3dd4721781ec25a5d8d27342942ae00aba80a3904d4); // this is just a placeholder value, you should replace it with the actual computed hash for depth 19
        } else if (i == 20) {
            return bytes32(0x087fde1c4c9c27c347f347083139eee8759179d255ec8381c02298d3d6ccd233); // this is just a placeholder value, you should replace it with the actual computed hash for depth 20
        } else if (i == 21) {
            return bytes32(0x1e26b1884cb500b5e6bbfdeedbdca34b961caf3fa9839ea794bfc7f87d10b3f1); // this is just a placeholder value, you should replace it with the actual computed hash for depth 21
        } else if (i == 22) {
            return bytes32(0x09fc1a538b88bda55a53253c62c153e67e8289729afd9b8bfd3f46f5eecd5a72); // this is just a placeholder value, you should replace it with the actual computed hash for depth 22
        } else if (i == 23) {
            return bytes32(0x14cd0edec3423652211db5210475a230ca4771cd1e45315bcd6ea640f14077e2); // this is just a placeholder value, you should replace it with the actual computed hash for depth 23
        } else if (i == 24) {
            return bytes32(0x1d776a76bc76f4305ef0b0b27a58a9565864fe1b9f2a198e8247b3e599e036ca); // this is just a placeholder value, you should replace it with the actual computed hash for depth 24
        } else if (i == 25) {
            return bytes32(0x1f93e3103fed2d3bd056c3ac49b4a0728578be33595959788fa25514cdb5d42f); // this is just a placeholder value, you should replace it with the actual computed hash for depth 25
        } else if (i == 26) {
            return bytes32(0x138b0576ee7346fb3f6cfb632f92ae206395824b9333a183c15470404c977a3b); // this is just a placeholder value, you should replace it with the actual computed hash for depth 26
        } else if (i == 27) {
            return bytes32(0x0745de8522abfcd24bd50875865592f73a190070b4cb3d8976e3dbff8fdb7f3d); // this is just a placeholder value, you should replace it with the actual computed hash for depth 27
        } else if (i == 28) {
            return bytes32(0x2ffb8c798b9dd2645e9187858cb92a86c86dcd1138f5d610c33df2696f5f6860); // this is just a placeholder value, you should replace it with the actual computed hash for depth 28
        } else if (i == 29) {
            return bytes32(0x2612a1395168260c9999287df0e3c3f1b0d8e008e90cd15941e4c2df08a68a5a); // this is just a placeholder value, you should replace it with the actual computed hash for depth 29
        } else if (i == 30) {
            return bytes32(0x10ebedce66a910039c8edb2cd832d6a9857648ccff5e99b5d08009b44b088edf); // this is just a placeholder value, you should replace it with the actual computed hash for depth 30
        } else if (i == 31) {
            return bytes32(0x213fb841f9de06958cf4403477bdbff7c59d6249daabfee147f853db7c808082); // this is just a placeholder value, you should replace it with the actual computed hash for depth 31
        } else {
